...
7. Produce a compiled review findings report under `docs/reviews/` using `references/findings-schema.md` as the baseline structured findings format and `references/review-findings-template.md` as the document layout.
...
7. Merge all reviewer findings into a compiled review findings report (save to `docs/reviews/` under a filename such as `docs/reviews/<date>-review-findings.md`) following the structure in `references/review-findings-template.md`
