...
- Every solution MUST include YAML frontmatter per `~/.pi/agent/git/github.com/pedrozadotdev/pi-pedstack/skills/05-learn/references/solution-schema.yaml` (title, category, severity, tags, applies_when).
- Use `~/.pi/agent/git/github.com/pedrozadotdev/pi-pedstack/skills/05-learn/references/category-map.md` to map the problem to the correct solution category.
